...
final class ReportGenerationTest extends TestCase
{
    ...
    public function testNextReportGenerationDateWeekly(): void
    {
        ...
        $weeklyMode = SettingsManager::REPORT_INTERVAL_MODE_WEEKLY;
    ...
    public function testNextReportGenerationDateMonthly(): void
    {
        ...
        $monthlyMode = SettingsManager::REPORT_INTERVAL_MODE_MONTHLY;
    ...
    public function testNextReportGenerationDateQuarterly(): void
    {
        ...
        $quarterlyMode = SettingsManager::REPORT_INTERVAL_MODE_QUARTERLY;
    ...
    {
        $mode = SettingsManager::REPORT_INTERVAL_MODE_WEEKLY;
        // test one week
    ...
    {
        // test one week
        $mode = SettingsManager::REPORT_INTERVAL_MODE_MONTHLY;
    ...
    {
        // test one week
        $mode = SettingsManager::REPORT_INTERVAL_MODE_QUARTERLY;
