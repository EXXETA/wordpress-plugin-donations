        ...
        self::$allCampaigns = [
            new CharityCampaign(CharityProductManager::$PROTECT_SPECIES_COIN_HH_DE,
                ...
                "Die Zahlen des Artenschutzberichtes des Weltbiodiversitätsrats IPBES sind alarmierend: Rund eine Million Arten könnten innerhalb 
						...
						<br>&quot;Im Yoga geht es darum, Einheit in der Vielfalt zu finden. Und wenn wir Tierformen einnehmen, dann spüren wir eigentlich, wie es diesen Tieren geht. Wir entwickeln Empathie, wir haben Mitgefühl und wollen, dass es nicht nur uns, sondern auch allen anderen Mitbewohnern auf diesem Planeten gut geht.“ - Patrick Broome&quot;
						<br>Gemeinsam mit dir möchten wir einen Beitrag zum Artenschutz leisten. Hilf mit deiner Spende die biologische Vielfalt auf unserem Planten zu erhalten! 
						<br>*Der gesamte Erlös der Spende kommt ausgewählten Artenschutzprojekten des WWF zugute. Bitte beachte, dass die Ausstellung einer Spendenquittung nicht möglich ist.
						<br>**Bitte beachte: Der WWF Euro ist kein physisches Produkt, sondern die Möglichkeit der digitalen Spende für den WWF. Eine Auslieferung und Rückerstattung des WWF Euros ist daher nicht möglich",
            ...
            new CharityCampaign(CharityProductManager::$PROTECT_SPECIES_COIN_HH_EN,
                ...
                "The statistics published in the Conservation Report created by the Intergovernmental Science-Policy Platform on Biodiversity and 
						...
						<br>&quot;Yoga is about finding unity in diversity.  When we take on the shapes of  animals, we create a connection with them and actually feel how they are feeling. We develop empathy, we have compassion and we long for the well-being of all lifes on this planet.“ - Patrick Broome&quot;
